...
public final class NBTTagCompound1_12_R1 implements INBTTagCompound {
    ...
    public NBTTagCompound1_12_R1(NBTTagCompound instance) {
    ...
    public INBTTagCompound getCompound(String k) {
        return new NBTTagCompound1_12_R1(instance.getCompound(k));
    }

    @Override
    public INBTTagList getList(String k, int i) {
        return new NBTTagList1_12_R1(instance.getList(k, i));
    }
    ...
    public INBTTagCompound getNBT(String s) {
        try {
            return new NBTTagCompound1_12_R1(MojangsonParser.parse(s));
        } catch (Exception e) {
    ...
    public INBTTagCompound getOrCreateNBT(ItemStack itemStack) {
        ...
        return new NBTTagCompound1_12_R1(nmsStack.getTag());
    }
}
