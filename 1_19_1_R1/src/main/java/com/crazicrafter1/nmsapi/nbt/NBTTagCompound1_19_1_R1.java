...
public final class NBTTagCompound1_19_1_R1 implements INBTTagCompound {
    ...
    public NBTTagCompound1_19_1_R1() {
        this(new NBTTagCompound());
    }
    public NBTTagCompound1_19_1_R1(NBTTagCompound instance) {
    ...
    public INBTTagCompound getCompound(String k) {
        return new NBTTagCompound1_19_1_R1(instance.p(k));
    }

    @Override
    public INBTTagList getList(String k, int i) {
        return new NBTTagList1_19_1_R1(instance.c(k, i));
    }
    ...
    public INBTTagCompound getNBT() {
        return new NBTTagCompound1_19_1_R1();
    }

    @Override
    public INBTTagCompound getNBT(String s) {
        try {
            return new NBTTagCompound1_19_1_R1(MojangsonParser.a(s));
