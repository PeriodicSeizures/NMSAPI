...
public final class NBTTagCompound1_16_R3 implements INBTTagCompound {
    ...
    public NBTTagCompound1_16_R3() {
        this(new NBTTagCompound());
    }
    public NBTTagCompound1_16_R3(NBTTagCompound instance) {
    ...
    public INBTTagCompound getCompound(String k) {
        return new NBTTagCompound1_16_R3(instance.getCompound(k));
    }

    @Override
    public INBTTagList getList(String k, int i) {
        return new NBTTagList1_16_R3(instance.getList(k, i));
    }
    ...
    public INBTTagCompound getNBT(String s) {
        try {
            return new NBTTagCompound1_16_R3(MojangsonParser.parse(s));
        } catch (Exception e) {
