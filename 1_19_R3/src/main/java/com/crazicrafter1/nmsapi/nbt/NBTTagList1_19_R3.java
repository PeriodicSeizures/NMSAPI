...
public class NBTTagList1_19_R3 extends INBTTagList {
    private NBTTagList instance;

    public NBTTagList1_19_R3() {
        instance = new NBTTagList();
    }
    public NBTTagList1_19_R3(NBTTagList instance) {
    ...
    public INBTTagCompound getCompound(int index) {
        return new NBTTagCompound1_19_R3(instance.a(index));
    }

    @Override
    public INBTTagList getNBTTagList(int index) {
        return new NBTTagList1_19_R3(instance.b(index));
    }
