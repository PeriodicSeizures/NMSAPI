...
public final class NBTTagCompound1_17_R1 implements INBTTagCompound {
    ...
    public NBTTagCompound1_17_R1() {
        this(new NBTTagCompound());
    }
    public NBTTagCompound1_17_R1(NBTTagCompound instance) {
    ...
    public INBTTagCompound getCompound(String k) {
        return new NBTTagCompound1_17_R1(instance.getCompound(k));
    }

    @Override
    public INBTTagList getList(String k, int i) {
        return new NBTTagList1_17_R1(instance.getList(k, i));
    }
    ...
    public INBTTagCompound getNBT() {
        return new NBTTagCompound1_17_R1();
    }

    @Override
    public INBTTagCompound getNBT(String s) {
        try {
            return new NBTTagCompound1_17_R1(MojangsonParser.parse(s));
