...
public class NBTTagList1_17_1_R1 extends INBTTagList {
    private NBTTagList instance;

    public NBTTagList1_17_1_R1() {
        instance = new NBTTagList();
    }
    public NBTTagList1_17_1_R1(NBTTagList instance) {
    ...
    public INBTTagCompound getCompound(int index) {
        return new NBTTagCompound1_17_1_R1(instance.getCompound(index));
    }

    @Override
    public INBTTagList getNBTTagList(int index) {
        return new NBTTagList1_17_1_R1(instance.b(index));
    }
