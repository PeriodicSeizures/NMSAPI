...
public class NBTTagList1_19_R2 extends INBTTagList {
    private NBTTagList instance;

    public NBTTagList1_19_R2() {
        instance = new NBTTagList();
    }
    public NBTTagList1_19_R2(NBTTagList instance) {
    ...
    public INBTTagCompound getCompound(int index) {
        return new NBTTagCompound1_19_R2(instance.a(index));
    }

    @Override
    public INBTTagList getNBTTagList(int index) {
        return new NBTTagList1_19_R2(instance.b(index));
    }
