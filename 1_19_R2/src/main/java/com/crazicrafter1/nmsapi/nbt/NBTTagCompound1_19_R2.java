...
public final class NBTTagCompound1_19_R2 implements INBTTagCompound {
    ...
    public NBTTagCompound1_19_R2() {
        this(new NBTTagCompound());
    }
    public NBTTagCompound1_19_R2(NBTTagCompound instance) {
    ...
    public INBTTagCompound getCompound(String k) {
        return new NBTTagCompound1_19_R2(instance.p(k));
    }

    @Override
    public INBTTagList getList(String k, int i) {
        return new NBTTagList1_19_R2(instance.c(k, i));
    }
    ...
    public INBTTagCompound getNBT() {
        return new NBTTagCompound1_19_R2();
    }

    @Override
    public INBTTagCompound getNBT(String s) {
        try {
            return new NBTTagCompound1_19_R2(MojangsonParser.a(s));
