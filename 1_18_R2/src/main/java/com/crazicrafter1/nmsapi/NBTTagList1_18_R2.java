...
public class NBTTagList1_18_R2 extends INBTTagList {
    private NBTTagList instance;

    public NBTTagList1_18_R2() {
        instance = new NBTTagList();
    }
    public NBTTagList1_18_R2(NBTTagList instance) {
    ...
    public INBTTagList getNBTTagList(int index) {
        return new NBTTagList1_18_R2(instance.b(index));
    }
